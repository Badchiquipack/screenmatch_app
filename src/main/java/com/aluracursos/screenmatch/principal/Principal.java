...
public class Principal {
    ...
    private final String API_KEY = "&apikey=161f02e9";
...
//        datosSeries.add(datos);
    ...
    private void filtrarSeriesPorTemporadaYEvaluacion() {
        ...
        teclado.nextLine();
        System.out.println("Introduce el valor de la evaluación:");
        var evaluacion = teclado.nextDouble();
        teclado.nextLine();
        List<Serie> filtroSeries = repositorio.
                seriesPorTemporadaYEvaluacion(totalTemporadas, evaluacion);
